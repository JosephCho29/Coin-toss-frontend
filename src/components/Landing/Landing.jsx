  ...
  return (
    <div className="carousel">
        ...
        {items.map((item, index) =>
          item.type === "video" ? (
            <video
              key={index}
              src={item.src}
              className="carousel-item carousel-video"
              controls
              autoPlay
              muted
            />
      ...
      <div className="carousel-arrows">
        <div className="carousel-arrow" onClick={handlePrevClick}>
          &#9664;
        </div>
        <div className="carousel-arrow" onClick={handleNextClick}>
          &#9654;
        </div>
      </div>
    </div>
      ...
      <landing-main>
        ...
        <div className="content">
          ...
          <div className="text">
            ...
            <button className="button" onClick={handleBetTeamsClick}>
              BET TEAMS
            </button>
          </div>
        </div>
